...
#include "my_robot_interfaces/msg/detail/robot_location__rosidl_typesupport_fastrtps_c.h"
...
using _RobotLocation__ros_msg_type = my_robot_interfaces__msg__RobotLocation;
...
size_t get_serialized_size_my_robot_interfaces__msg__RobotLocation(
  const void * untyped_ros_message,
...
static uint32_t _RobotLocation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__RobotLocation(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__RobotLocation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__RobotLocation;
    is_plain =
      (
...
static size_t _RobotLocation__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_my_robot_interfaces__msg__RobotLocation(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, RobotLocation)() {
