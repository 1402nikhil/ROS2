...
#include "my_robot_interfaces/msg/detail/robot_location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::RobotLocation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::RobotLocation & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::RobotLocation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::RobotLocation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::RobotLocation *>(
    untyped_ros_message);
...
static size_t _RobotLocation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotLocation(full_bounded, is_plain, 0);
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_RobotLocation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, RobotLocation)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_RobotLocation__handle;
}
