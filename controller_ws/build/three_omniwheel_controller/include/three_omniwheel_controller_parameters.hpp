#pragma message("#include \"three_omniwheel_controller_parameters.hpp\" is deprecated. Use #include <three_omniwheel_controller/three_omniwheel_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        double chassis_side_length = 0.0;
        double drive_wheel_radius = 0.0;
        double front_wheel_radius_multiplier = 1.0;
        double back_right_wheel_radius_multiplier = 1.0;
        double back_left_wheel_radius_multiplier = 1.0;
        double dead_wheel_radius = 0.0;
        double x_wheel_radius_multiplier = 1.0;
        double y_wheel_radius_multiplier = 1.0;
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("three_omniwheel_controller"), prefix) {
    ...
    StackParams get_stack_params() {
      ...
      StackParams output;
      output.chassis_side_length = params.chassis_side_length;
      output.drive_wheel_radius = params.drive_wheel_radius;
      output.front_wheel_radius_multiplier = params.front_wheel_radius_multiplier;
      ...
      output.dead_wheel_radius = params.dead_wheel_radius;
      output.x_wheel_radius_multiplier = params.x_wheel_radius_multiplier;
      output.y_wheel_radius_multiplier = params.y_wheel_radius_multiplier;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "front_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.front_wheel_name = param.as_string();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "back_right_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.back_right_wheel_name = param.as_string();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "back_left_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.back_left_wheel_name = param.as_string();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "x_dead_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.x_dead_wheel_name = param.as_string();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "y_dead_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.y_dead_wheel_name = param.as_string();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "chassis_side_length")) {
            if(auto validation_result = gt<double>(param, 0.0);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.chassis_side_length = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "drive_wheel_radius")) {
            if(auto validation_result = gt<double>(param, 0.0);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.drive_wheel_radius = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "front_wheel_radius_multiplier")) {
            updated_params.front_wheel_radius_multiplier = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        ...
        if (param.get_name() == (prefix_ + "dead_wheel_radius")) {
            if(auto validation_result = gt<double>(param, 0.0);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.dead_wheel_radius = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "x_wheel_radius_multiplier")) {
            updated_params.x_wheel_radius_multiplier = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "y_wheel_radius_multiplier")) {
            updated_params.y_wheel_radius_multiplier = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "front_wheel_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the front wheel of the chassis";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.front_wheel_name);
          parameters_interface_->declare_parameter(prefix_ + "front_wheel_name", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "back_right_wheel_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the back right wheel of the chassis";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.back_right_wheel_name);
          parameters_interface_->declare_parameter(prefix_ + "back_right_wheel_name", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "back_left_wheel_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the back left wheel of the chassis";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.back_left_wheel_name);
          parameters_interface_->declare_parameter(prefix_ + "back_left_wheel_name", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "x_dead_wheel_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the x dead wheel of the chassis";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.x_dead_wheel_name);
          parameters_interface_->declare_parameter(prefix_ + "x_dead_wheel_name", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "y_dead_wheel_name")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Name of the y dead wheel of the chassis";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.y_dead_wheel_name);
          parameters_interface_->declare_parameter(prefix_ + "y_dead_wheel_name", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "chassis_side_length")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Lenght of the one side of the chassis";
          descriptor.read_only = false;
          ...
          auto parameter = to_parameter_value(updated_params.chassis_side_length);
          parameters_interface_->declare_parameter(prefix_ + "chassis_side_length", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "drive_wheel_radius")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          ...
          descriptor.floating_point_range.at(0).from_value = 0.0;
          descriptor.floating_point_range.at(0).to_value = std::numeric_limits<double>::max();
          auto parameter = to_parameter_value(updated_params.drive_wheel_radius);
          parameters_interface_->declare_parameter(prefix_ + "drive_wheel_radius", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "front_wheel_radius_multiplier")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          ...
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.front_wheel_radius_multiplier);
          parameters_interface_->declare_parameter(prefix_ + "front_wheel_radius_multiplier", parameter, descriptor);
      }
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "dead_wheel_radius")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Radius of a wheel, i.e., wheels size, used for transformation of linear velocity into wheel rotations. If this parameter is wrong the robot will move faster or slower then expected.";
          descriptor.read_only = false;
          descriptor.floating_point_range.resize(1);
          descriptor.floating_point_range.at(0).from_value = 0.0;
          descriptor.floating_point_range.at(0).to_value = std::numeric_limits<double>::max();
          auto parameter = to_parameter_value(updated_params.dead_wheel_radius);
          parameters_interface_->declare_parameter(prefix_ + "dead_wheel_radius", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "x_wheel_radius_multiplier")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Correction factor when radius of right wheels differs from the nominal value in wheel_radius parameter.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.x_wheel_radius_multiplier);
          parameters_interface_->declare_parameter(prefix_ + "x_wheel_radius_multiplier", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "y_wheel_radius_multiplier")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Correction factor when radius of right wheels differs from the nominal value in wheel_radius parameter.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.y_wheel_radius_multiplier);
          parameters_interface_->declare_parameter(prefix_ + "y_wheel_radius_multiplier", parameter, descriptor);
      }
      ...
      rclcpp::Parameter param;
      param = parameters_interface_->get_parameter(prefix_ + "front_wheel_name");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'front_wheel_name': {}", validation_result.error()));
      }
      updated_params.front_wheel_name = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "back_right_wheel_name");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'back_right_wheel_name': {}", validation_result.error()));
      }
      updated_params.back_right_wheel_name = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "back_left_wheel_name");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'back_left_wheel_name': {}", validation_result.error()));
      }
      updated_params.back_left_wheel_name = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "x_dead_wheel_name");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'x_dead_wheel_name': {}", validation_result.error()));
      }
      updated_params.x_dead_wheel_name = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "y_dead_wheel_name");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'y_dead_wheel_name': {}", validation_result.error()));
      }
      updated_params.y_dead_wheel_name = param.as_string();
      param = parameters_interface_->get_parameter(prefix_ + "chassis_side_length");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = gt<double>(param, 0.0);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'chassis_side_length': {}", validation_result.error()));
      }
      updated_params.chassis_side_length = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "drive_wheel_radius");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = gt<double>(param, 0.0);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'drive_wheel_radius': {}", validation_result.error()));
      }
      updated_params.drive_wheel_radius = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "front_wheel_radius_multiplier");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.front_wheel_radius_multiplier = param.as_double();
      ...
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.back_left_wheel_radius_multiplier = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "dead_wheel_radius");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = gt<double>(param, 0.0);
        !validation_result) {
          throw rclcpp::exceptions::InvalidParameterValueException(fmt::format("Invalid value set during initialization for parameter 'dead_wheel_radius': {}", validation_result.error()));
      }
      updated_params.dead_wheel_radius = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "x_wheel_radius_multiplier");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.x_wheel_radius_multiplier = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "y_wheel_radius_multiplier");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.y_wheel_radius_multiplier = param.as_double();
    ...
    private:
      ...
      rclcpp::Logger logger_ = rclcpp::get_logger("three_omniwheel_controller");
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "front_wheel_name")) {
            if(auto validation_result = not_empty(param, true);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.front_wheel_name = param.as_string();
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "front_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param, true);
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
            updated_params.front_wheel_name = param.as_string();
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        std::string back_right_wheel_name = "back_right_wheel_joint";
        std::string back_left_wheel_name = "back_left_wheel_joint";
        std::string x_dead_wheel_name = "x_dead_wheel_joint";
        std::string y_dead_wheel_name = "y_dead_wheel_joint";
        double chassis_side_length = 0.0;
        double drive_wheel_radius = 0.0;
        double front_wheel_radius_multiplier = 1.0;
        double back_right_wheel_radius_multiplier = 1.0;
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        std::vector<std::string> front_wheel_name = {};
        std::vector<std::string> back_right_wheel_name = {};
        std::vector<std::string> back_left_wheel_name = {};
        std::vector<std::string> x_dead_wheel_name = {};
        std::vector<std::string> y_dead_wheel_name = {};
        double chassis_side_length = 0.0;
        double drive_wheel_radius = 0.0;
        double front_wheel_radius_multiplier = 1.0;
        double back_right_wheel_radius_multiplier = 1.0;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "front_wheel_name")) {
            ...
            updated_params.front_wheel_name = param.as_string_array();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "back_right_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
            ...
            updated_params.back_right_wheel_name = param.as_string_array();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "back_left_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
            ...
            updated_params.back_left_wheel_name = param.as_string_array();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "x_dead_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
            ...
            updated_params.x_dead_wheel_name = param.as_string_array();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "y_dead_wheel_name")) {
            if(auto validation_result = not_empty<std::string>(param);
            ...
            updated_params.y_dead_wheel_name = param.as_string_array();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "chassis_side_length")) {
            if(auto validation_result = gt<double>(param, 0.0);
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    StackParams get_stack_params() {
      ...
      output.angular.z.max_jerk = params.angular.z.max_jerk;
      output.angular.z.min_jerk = params.angular.z.min_jerk;
      output.angular.x.has_velocity_limits = params.angular.x.has_velocity_limits;
      output.angular.x.has_acceleration_limits = params.angular.x.has_acceleration_limits;
      output.angular.x.has_jerk_limits = params.angular.x.has_jerk_limits;
      output.angular.x.max_velocity = params.angular.x.max_velocity;
      output.angular.x.min_velocity = params.angular.x.min_velocity;
      output.angular.x.max_acceleration = params.angular.x.max_acceleration;
      output.angular.x.min_acceleration = params.angular.x.min_acceleration;
      output.angular.x.max_jerk = params.angular.x.max_jerk;
      output.angular.x.min_jerk = params.angular.x.min_jerk;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "angular.x.has_velocity_limits")) {
            updated_params.angular.x.has_velocity_limits = param.as_bool();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.has_acceleration_limits")) {
            updated_params.angular.x.has_acceleration_limits = param.as_bool();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.has_jerk_limits")) {
            updated_params.angular.x.has_jerk_limits = param.as_bool();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.max_velocity")) {
            updated_params.angular.x.max_velocity = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.min_velocity")) {
            updated_params.angular.x.min_velocity = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.max_acceleration")) {
            updated_params.angular.x.max_acceleration = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.min_acceleration")) {
            updated_params.angular.x.min_acceleration = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.max_jerk")) {
            updated_params.angular.x.max_jerk = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "angular.x.min_jerk")) {
            updated_params.angular.x.min_jerk = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
      }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.has_velocity_limits")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.has_velocity_limits);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.has_velocity_limits", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.has_acceleration_limits")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.has_acceleration_limits);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.has_acceleration_limits", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.has_jerk_limits")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.has_jerk_limits);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.has_jerk_limits", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.max_velocity")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.max_velocity);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.max_velocity", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.min_velocity")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.min_velocity);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.min_velocity", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.max_acceleration")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.max_acceleration);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.max_acceleration", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.min_acceleration")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.min_acceleration);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.min_acceleration", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.max_jerk")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.max_jerk);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.max_jerk", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "angular.x.min_jerk")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.angular.x.min_jerk);
          parameters_interface_->declare_parameter(prefix_ + "angular.x.min_jerk", parameter, descriptor);
      }
      // get parameters and fill struct fields
      rclcpp::Parameter param;
      param = parameters_interface_->get_parameter(prefix_ + "front_wheel_name");
      ...
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.z.min_jerk = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.has_velocity_limits");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.has_velocity_limits = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.has_acceleration_limits");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.has_acceleration_limits = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.has_jerk_limits");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.has_jerk_limits = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.max_velocity");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.max_velocity = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.min_velocity");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.min_velocity = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.max_acceleration");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.max_acceleration = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.min_acceleration");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.min_acceleration = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.max_jerk");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.max_jerk = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "angular.x.min_jerk");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.angular.x.min_jerk = param.as_double();
